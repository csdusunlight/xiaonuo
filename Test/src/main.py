...
klist = ['mobile','time','first_invest_time','first_invest_amount','total_amount',
...
def get_data():
    ...
    with open('conf.txt') as f:
        for line in f:
            ...
            s = line.split(':')
            read[s[0]] = s[1]
    url_at = 'http://'+read.get('ip')+'/admin/cps/login.c'
    ...
    url_at2 = 'http://'+read.get('ip')+'/admin/cps/jyz.c'
    param2 = {'token':token,
